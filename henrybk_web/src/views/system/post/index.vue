<template>
  <div class="app-container">
          ...
          <el-row>
            <el-col :span="6">
              <el-form-item label="岗位编码">
                <el-input style="width: 95%" v-model="searchObj.postCode" placeholder="请输入岗位编码"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="岗位名称">
                <el-input style="width: 95%" v-model="searchObj.name" placeholder="请输入岗位名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="岗位状态" prop="status">
                <el-select id="status" v-model="searchObj.status" placeholder="岗位状态" clearable style="width: 95%">
    ...
    <el-table v-loading="listLoading" :data="list" style="width: 100%;margin-top: 10px;"
      ...
      <el-table-column prop="postCode" label="岗位编码" width="100" align="center" />
      <el-table-column prop="name" label="岗位名称" width="120" align="center" />
    ...
    <el-dialog :title="title" :visible.sync="dialogVisible" width="40%">
      <el-form ref="dataForm" :model="saveOrUpdateForm" :rules="rules" label-width="100px" size="small" style="padding-right: 40px;">
        <el-form-item label="岗位编码" prop="postCode">
          <el-input v-model="saveOrUpdateForm.postCode" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$myconfirm('确认要' + text + '[' + row.name + ']岗位吗？').then(() => {
    ...
    batchRemove() {
      ...
      this.$myconfirm('确认要删除已勾选的岗位吗？').then(() => {
