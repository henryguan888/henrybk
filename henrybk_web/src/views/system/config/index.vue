<template>
  <div class="app-container">
          ...
          <el-row>
            <el-col :span="6">
              <el-form-item label="参数键名">
                <el-input style="width: 95%" v-model="searchObj.configKey" placeholder="请输入参数键名"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="参数名称">
                <el-input style="width: 95%" v-model="searchObj.configName" placeholder="请输入参数名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
    ...
    <el-table v-loading="listLoading" :data="list" style="width: 100%;margin-top: 10px;"
      ...
      <el-table-column prop="configKey" label="参数键名" width="180" align="center" />
      <el-table-column prop="configValue" label="参数键值" width="300" align="center" />
      <el-table-column prop="configName" label="参数名称" width="160" align="center" />
    ...
    <el-dialog :title="title" :visible.sync="dialogVisible" width="40%">
      <el-form ref="dataForm" :model="saveOrUpdateForm" :rules="rules" label-width="100px" size="small" style="padding-right: 40px;">
        <el-form-item label="参数键名" prop="configKey">
          <el-input v-model="saveOrUpdateForm.configKey" />
        </el-form-item>
        <el-form-item label="参数键值" prop="configValue">
          <el-input v-model="saveOrUpdateForm.configValue" />
        </el-form-item>
        <el-form-item label="参数名称" prop="configName">
          <el-input v-model="saveOrUpdateForm.configName" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    // 根据id删除数据
    removeDataById(id) {
      this.$myconfirm('确认要删除该系统配置信息吗？').then(() => {
    ...
    batchRemove() {
      ...
      this.$myconfirm('确认要删除已勾选的系统配置信息吗？').then(() => {
